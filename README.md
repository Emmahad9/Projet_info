...
Cependant, si l'option que vous mettez lors de la compilation est différente de celles ci-dessus le programme ne la comptera pas et compilera comme si vous n'aviez pas mis d'option. Il compilera de manière général (cas général).
